CREATE TABLE IF NOT EXISTS `oauther`.`clients` (
 ...
 `client_secret` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'app secret',
 `client_name` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'client''s name',
 `redirect_uri` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'client''s redirect URL',
